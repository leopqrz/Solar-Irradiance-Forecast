...
DEFAULT_START_DATE = dt.datetime(2001, 1, 1)
bar.progress(10)
START_DATE = sub_columns[0].date_input(
    'From', value=DEFAULT_START_DATE, max_value=LAST_DATE)
END_DATE = sub_columns[1].date_input(
    'To', value=LAST_DATE, min_value=START_DATE)
...
START_TIME = sub_columns[0].time_input(
    'From', value=DEFAULT_START_TIME, label_visibility='collapsed')
END_TIME = sub_columns[1].time_input(
    'To', value=LAST_TIME, label_visibility='collapsed')
...
UNIT = ['dimensionless', '°C', 'lux', 'lux', 'lux',
        '%', 'g/Kg', 'KPa', '°C', 'Not Available', 'm/s']
